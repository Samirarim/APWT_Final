...
export async function getServerSideProps({ query }) {
  ...
  try {
  const response = await axios.get('advancedwebtech-useremployee-production.up.railway.app/waiter/getmenu/'+inputValue);
  ...
  return {
    props: {
      data: {color:"red",status:"enter valid menu id"}
    }
  };
}
}